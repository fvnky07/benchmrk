...
// for passwordless waitlist auth. Placed in convex/betterAuth/
// per official Convex integration docs.
...
// NOTE: ~10 years in milliseconds for "lifetime" premium
  ...
  return {
    ...
    hooks: {
      after: createAuthMiddleware(async (hookCtx) => {
        ...
        // NOTE: Count current premium users by checking
        // premiumUntil > now
        const now = Date.now();
