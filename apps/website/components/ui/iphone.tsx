...
export function Iphone({
  ...
  // NOTE: Track loading state for video/image
  ...
  return (
    <div
      ...
      {...props}
    >
      {/* NOTE: Skeleton loading state - shows while media is loading */}
      {isLoading && hasMedia && (
        <div
      ...
      {!hasVideo && src && (
        <div
          className="pointer-events-none absolute z-0 overflow-hidden shadow-2xl"
          style={{
            left: `${LEFT_PCT}%`,
            top: `${TOP_PCT}%`,
            width: `${WIDTH_PCT}%`,
