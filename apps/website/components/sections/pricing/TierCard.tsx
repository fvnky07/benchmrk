// Generated by OpenCode AI - TierCard Refactor - 2026-02-07
import { cn } from '@/lib/utils';
import { ArrowRight, BadgeCheck } from 'lucide-react';
import { Badge } from '@/components/ui/badge';
import { Button } from '@/components/ui/button';

// NOTE: PricingTier interface defines the shape of tier data
  ...
  return (
    ...
    >
      ...
      <div className="relative h-12">
        {typeof price === 'number' ? (
          <>
            <div className="text-4xl font-medium">${price.toFixed(0)}</div>
