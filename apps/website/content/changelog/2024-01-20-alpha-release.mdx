...
<Accordion type="multiple" collapsible="true" className="not-prose w-full">
  <AccordionItem value="item-1">
    <AccordionTrigger className="text-[#00ff00]">+ Features</AccordionTrigger>
  ...
  <AccordionItem value="item-2">
    <AccordionTrigger className="text-[#ff0000]">- Bug Fixes</AccordionTrigger>
    <AccordionContent className="flex flex-col gap-4 text-balance">
      <ul className="list-disc space-y-2 pl-4">
        <li>
